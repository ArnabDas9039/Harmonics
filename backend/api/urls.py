...
urlpatterns = [
    ...
    path("playlist/<id>/update/", views.UpdatePlaylistView.as_view(), name = "playlist_info"),
    path("playlists/feed/", views.PlaylistListView.as_view(), name = "from_community"),
    path("library/playlists/", views.PlaylistListSecureView.as_view(), name = "user_playlist"),
