...
urlpatterns = [
    ...
    # ),
    path("library/create/", views.CreateLibraryView.as_view(), name="library_post"),
    path("library/", views.LibraryView.as_view(), name="library"),
    path("history/create/", views.CreateHistoryView.as_view(), name="history_post"),
    path("history/", views.HistoryView.as_view(), name="history_get"),
    path("radio/<public_id>", views.RadioView.as_view(), name="radio"),
    path("radio/create/", views.CreateRadioView.as_view(), name="radio_post"),
